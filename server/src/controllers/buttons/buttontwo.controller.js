...
const buttontwoController = {
  ...
  getLink: async (req, res) => {
    try {
      const query = "SELECT * FROM button_links WHERE id = 2"; // 2 is the button ID
  ...
  updateLink: async (req, res) => {
    try {
      ...
      const query = "UPDATE button_links SET url = ? WHERE id = 2";
...
module.exports = buttontwoController;
