...
const buttonthreeController = {
  ...
  getLink: async (req, res) => {
    try {
      const query = "SELECT * FROM button_links WHERE id = 3"; // 2 is the button ID
...
updateLink: async (req, res) => {
  try {
    ...
    const query = "UPDATE button_links SET url = ? WHERE id = 3";
...
module.exports = buttonthreeController;
